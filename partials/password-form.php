...
<form action="<?php echo esc_url(site_url('wp-login.php?action=postpass', 'login_post')); ?>" class="post-password-form form-inline" method="post">
    <div class="form-group">
        <p id="passwordHelpBlock" class="form-text"><?php _e('This content is password protected. To view it please enter your password below:'); ?></p>
    ...
    <button type="submit" class="btn btn-secondary" name="Submit"><?php _e('Submit'); ?></button>
</form>
