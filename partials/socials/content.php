<hr />
<div class="share-links text-center clearfix">
    <ul class="list-inline">
        <!-- facebook -->
        <li>
            <a class="btn btn-social-icon btn-facebook" title="<?php
        ...
        <!-- twitter -->
        <li>
            <a class="btn btn-social-icon btn-twitter" title="<?php
        ...
        <!-- google plus -->
        <li>
            <a class="btn btn-social-icon btn-google" title="<?php
        ...
        <!-- reddit -->
        <li>
            <a class="btn btn-social-icon btn-reddit" title="<?php
        ...
        <!-- linkedin -->
        <li>
            <a class="btn btn-social-icon btn-linkedin" title="<?php
        ...
        <!-- pinterest -->
        <li>
            <a class="btn btn-social-icon btn-pinterest" title="<?php
